import { allCharactersQuery, singleCharacterQuery } from '@/utils/graphql/queries';
import { IGraphqlAllCharacters, IGraphqlSingleCharacter } from '@/utils/interfaces/graphql';
...
export const getAllCharacters = async (page: string = '1', name: string = ''): Promise<ICharactersResponse | ErrorResponse> => {
...
export const getSingleCharacter = async (id: string): Promise<ICharacter | ErrorResponse> => {
